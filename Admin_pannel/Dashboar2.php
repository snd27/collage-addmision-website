...
// Add the SQL query before using `$result`
$sql = "SELECT * FROM admissions2"; // Change `admissions2` to your actual table name
...
<head>
    ...
    <title>Dashboard - 2nd Year Admissions</title>
    <style>
        body {
...
<div class="container">
    <h2>2nd Year Admissions Records</h2>
